...
function Footer() {
  return (
    <>
      <footer className="bg-white dark:bg-teal-800 antialiased">
        <div className="p-4 py-6 mx-auto max-w-screen-xl md:p-8 lg:p-10">
          <div className="text-center">
            <Link
              to="/"
              className="flex justify-center items-center mb-5 text-2xl font-semibold text-teal-900 dark:text-white"
              onClick={() =>
                window.scrollTo({
                  top: 0,
                  left: 0,
            ...
            <div className="w-auto p-4 sm:p-8 flex flex-wrap justify-center items-center gap-2">
              <span className="text-sm text-center text-teal-800 dark:text-teal-400">
                © {new Date().getFullYear()} All Rights Reserved.
              </span>
              <ul className="inline-flex items-center">
                {menuItems.map((item) => (
                  <li key={item.text}>
                    <span className="px-2 font-bold text-teal-700">|</span>
                    <Link
                      className="text-teal-700 hover:text-teal-900 hover:font-medium duration-300"
                      to={item.href}
                      onClick={() =>
                        window.scrollTo({
                          top: 0,
            ...
            <ul className="flex justify-center mt-5 space-x-5">
              <li>
                <a
                  href="#"
                  target="_blank"
                  className="text-teal-700 hover:text-teal-900 dark:hover:text-white dark:text-teal-400 duration-300"
                >
                  <svg
                    className="h-4 w-4"
                    aria-hidden="true"
